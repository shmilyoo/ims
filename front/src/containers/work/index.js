...
import EditWorkTask from './EditWorkTask';
import WorkArticleInfo from './WorkArticleInfo';
...
const Work = ({ match }) => {
  return (
    <Switch>
      ...
      <Route
        exact
        path={`${match.path}/article/info`}
        component={WorkArticleInfo}
      />
      <Route
        exact
      ...
      <Route exact path={`${match.path}/task/edit`} component={EditWorkTask} />
